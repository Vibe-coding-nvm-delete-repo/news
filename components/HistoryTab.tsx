  ...
  if (reportHistory.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-slate-700 mb-2">No Report History</h3>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-slate-600 bg-slate-100 px-3 py-1 rounded-full">
          {reportHistory.length} {reportHistory.length === 1 ? 'report' : 'reports'}
        </span>
      </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-purple-900">Keywords</span>
                  </div>
                ...
                <div className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-yellow-900">Cards</span>
                  </div>
                  <p className="text-2xl font-bold text-slate-900">{report.totalCards}</p>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-blue-900">Model</span>
                  </div>
                  <p className="text-xs font-medium text-slate-900 truncate" title={report.modelUsed}>
